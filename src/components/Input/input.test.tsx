...
describe('test Input component',()=>{
    it('should render the correct default Input',()=>{
        ...
        expect(testNode).toHaveClass('money-input-inner')
    ...
    it('should render different input sizes on size property',()=>{
        ...
        const testContainer = wrapper.container.querySelector('.money-input-wrapper')
    ...
    it('should render prepand and append element on prepend/append property',()=>{
        ...
        const testContainer = container.querySelector('.money-input-wrapper')
